    ...
    dias: [
      ...
      },
      {
        ...
        exercicios: [
          ...
          { ex: 'triceps-testa', series: 3, reps: [8, 12], kg: 30, inc: 2.5, nota: 'Barra W de 10 kg incluída — 30 kg são a barra mais 10 de cada lado. Carga acertada na sessão de 11 de Setembro. Os 20 do princípio são aquecimento — as três séries de trabalho são todas a 30' }
        ]
      },
      {
        k: 'C',
