    ...
    dias: [
      {
        ...
        exercicios: [
          ...
          { ex: 'crunch-bicicleta', series: 3, reps: [16, 30], max: true, nota: 'Deitado no chão, cotovelo ao joelho contrário, devagar. Conta-se cada lado como uma repetição' }
        ]
      },
      {
        k: 'B',
